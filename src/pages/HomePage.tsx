  ...
  return (
    <div className="bg-brand-bg">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://portsaid.vtexassets.com/assets/vtex.file-manager-graphql/images/8f1c82ca-99b0-4e47-ad28-67d62aa46296___a3e87c6109855910760cb9da2c2ec6fa.jpg",
        }}
      >
      ...
      <section ref={productsRef} className="py-20 px-4 scroll-animate">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="text-center mt-16">
            <Link
              to="/tienda"
              className="font-bold text-black border border-black px-10 py-4 hover:bg-black hover:text-white transition-colors text-sm tracking-widest"
            >
