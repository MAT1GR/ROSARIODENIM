...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gradient-to-b from-brand-pink to-brand-pink-dark text-white py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/tienda" className="text-white/80 hover:text-white transition-colors">
                  Todos los Productos
                </Link>
              </li>
              <li>
                <Link to="/tallas" className="text-white/80 hover:text-white transition-colors">
                  Guía de Tallas
                </Link>
              </li>
              <li>
