        ...
        {cartItems.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center text-center p-6">
            ...
            <Link
              to="/tienda"
              onClick={onClose}
              className="inline-flex items-center gap-2 bg-[#D8A7B1] hover:bg-[#c69ba5] text-white px-8 py-3 rounded-lg font-medium transition-colors group"
            >
              Ver productos
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">Talle: {item.size}</p>
                      </div>
                      <button
            ...
            <div className="p-6 border-t bg-white">
              <div className="flex justify-between items-center text-lg">
               ...
               <p className="text-right text-sm text-gray-500 mt-1 mb-4">
                  O hasta 24 x $ {(total / 24).toLocaleString('es-AR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                </p>
              
              <Link
                to="/checkout/info"
                onClick={onClose}
                className="w-full block text-center bg-[#D8A7B1] hover:bg-[#c69ba5] text-white py-3 rounded-lg text-lg font-bold transition-colors"
              >
                Iniciar Compra
              </Link>
              <div className="text-center mt-3">
                <Link
                  to="/tienda"
                  onClick={onClose}
                  className="text-sm font-medium text-[#D8A7B1] hover:underline"
                >
                  Ver más productos
                </Link>
              </div>
